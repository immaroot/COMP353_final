                        ...
                        <div class="card-body">
                            <div class="card-text">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <a class="btn btn-link" href="{{ url('employer/payments/methods/' . $payment_method->id . '/edit') }}">Modify</a>
                                        <form action="{{ url('employer/payments/methods/'. $payment_method->id) }}" method="post">
