        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="company_name" class="col-md-4 col-form-label text-md-right">{{ __('Your Company\'s Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Your Company\'s Phone Number') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="website" class="col-md-4 col-form-label text-md-right">{{ __('Your Company\'s Website') }}</label>
                        ...
                        <div class="card-text text-center m-5">
                            Are you an job seeker? <a href="{{ url('/job_seeker/register') }}" class="card-link"> click here </a>
                        </div>
                    </form>
                </div>
            </div>
